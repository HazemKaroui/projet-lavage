...
<body>
  ...
  <!-- Start Navbar -->
  <nav id="accueil" class="navbar navbar-expand-lg navbar-light">
    <div class="container">
      <a class="navbar-brand" href="">
        <!-- <span>Car</span><span>Wash</span> -->
        <img src="img/car wash (4).png" width="70px" alt="">
      </a>
      <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#main-nav" aria-controls="nmain-nav" aria-expanded="false" aria-label="Toggle navigation">
      ...
      <div class="collapse navbar-collapse" id="main-nav">
        <ul class="navbar-nav ms-auto">
          ...
          <li class="nav-item">
            <a class="nav-link" href="#prix">Equipe</a>
          </li>
          <li class="nav-item">
    ...
    <div class="container-fluid">
      <div class="row">
        <div class="info col-xl-6">
          <img src="img/anastas-mateev-Uxooollwo9k-unsplash.jpg" alt="" />
        </div>
        <div class="info col-xl-6">
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-4 text-center text-md-right">
          <a href="#footer">Contacter nous </a>
        </div>
      </div>
    </div>
  </div>
      ...
      <div class="row">
        <div class="col-sm-12 col-lg-6">
          <div class="map-responsive">
            <h2><span>Car</span><span>Wash Map</span></h2>
            <iframe  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3235.584490797968!2d10.638832915262345!3d35.810132680164465!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x1302753ff4f9ed1b%3A0x6b66244aa621df76!2sRue%20Yasser%20Arafat%2C%20Sousse!5e0!3m2!1sfr!2stn!4v1639569512782!5m2!1sfr!2stn" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
          </div>
        </div>
        ...
        <div class="col-sm-6 col-lg-3">
          <div id="footer" class="contact">
            ...
            <ul class="list-unstyled">
              <li>Rue Yecer arafat ,Sahloul, Sousse </li>
              <li>Numéro Telephone 1: 25256358</li>
              <li>Numéro Telephone 2: 99487568</li>
              <li>Numéro Telephone fixe : 73458698</li>
              <li>Email: <a href="Carwash@gmail.com">Carwash@gmail.com</a></li>
            </ul>
          </div>
        </div>
      </div>
